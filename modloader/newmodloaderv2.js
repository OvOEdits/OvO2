...
(function () {
    ...
    class ModLoader {
        ...
        loadModURL(url, local = false, notify = true) {
            if (local) {
                url = this.getModDirectory() + "v2/" + url;
            }
        ...
        loadModJSON(key, json, notify = true) {
            const url = this.getModDirectory() + "v2/" + json.url;
    ...
    if (typeof window.ovoModLoader === "undefined") {
        if (typeof window.c3_runtimeInterface._GetLocalRuntime !== "undefined" && window.c3_runtimeInterface._GetLocalRuntime() != null && typeof window.c3_runtimeInterface._GetLocalRuntime() !== "undefined" && window.c3_runtimeInterface._GetLocalRuntime().isloading === false) {
